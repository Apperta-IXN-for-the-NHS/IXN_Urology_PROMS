...
export let SupportInfo = [
  {
    ...
    preview: "How self help groups can be beneficial for cancer patients",
    description:
  ...
  {
    title: "Exercise",
    preview: "Learn about the importance of exercise and it's link with cancer",
    description:
      "Exercise improves heart health and bone density, as well as decreases the risk of diabetes and obesity. In addition, exercise can decrease blood sugar levels, which lowers insulin levels and inflammation. That’s important because there appears to be an association between insulin levels, inflammation, and prostate cancer risk. The other big benefit of exercise is that it can reduce the side effects of common prostate cancer treatments.",
    image: exerciseImg,
  },
  {
    title: "Counselling",
    preview: "One to one support help for whenever you may need it",
    description:
      "The important thing to remember when you’re affected by prostate disease is that you’re not alone. There are lots of people out there who are on very similar journeys, and who have had the treatments and experiences you may be facing. Follow the links below to find one-to-one support resources.",
